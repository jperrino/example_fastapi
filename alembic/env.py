...
# import Base class to get the metadata
from app.models import Base

# import settings to retrieve db_conn_string
...
# changing the sqlalchemy.url value dynamically to prevent hard coding the db_conn_string value
